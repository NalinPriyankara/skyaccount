...
const stats = [
  {
    ...
    description: "Expert professionals dedicated to delivering innovative IoT and automation solutions.",
    icon: Users
  },
  {
    id: 2,
    ...
    description: "Diverse projects across various industries showcasing our expertise and commitment.",
    icon: FolderKanban 
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Two decades of industry experience driving innovation and excellence.",
    icon: Clock
  }
];
