      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/reset-password" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">
              Forgot password?
            </Link>
          </div>
          {error && (
          ...
          <motion.button
            ...
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-500 hover:to-blue-600 text-black font-semibold rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
          ...
          {/* <div className="space-y-3">
            <button
              type="button"
              className="w-full py-3 px-4 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-all duration-200 flex items-center justify-center"
            >
